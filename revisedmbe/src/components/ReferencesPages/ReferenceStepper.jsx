...
const Step = ({ index, label, completed, onClick }) => (
    ...
    >
        <div
            className={`w-8 h-8 p-0.5 rounded-[999px] flex-col justify-center items-center inline-flex ${completed ? "bg-lime-500" : "bg-blue-800"
                }`}
        >
            {completed ? (
...
export default function ReferenceStepper() {
