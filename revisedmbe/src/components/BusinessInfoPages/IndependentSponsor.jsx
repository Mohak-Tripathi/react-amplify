...
const IndependentSponsor = ({ handleClose, handleSave }) => {

    const { independentSponsor } = useSelector((store) => store.businessInfo)
    const [isAddPdf, setAddPdf] = useState(Object.keys(independentSponsor).length >= 1 ? independentSponsor : {});
    const dispatch = useDispatch()



    const onFilesChange = (e) => {
        // console.log(e, isAddPdf)
    ...
    const [independentSponsorForm, setIndependentSponsorForm] = useState([{ zipCode: '', numberOfInvestor: '', numberOfMinority:'' }]);
    ...
    function handleInputChange(e, fieldName, fieldType) { // ! use "i" if your form is array
        if (handleCheckInput(e, fieldType, independentSponsorForm[0][fieldName])) {
        ...
        function updateField(fieldName, e) {
            if (e.target.value !== "undefined") {
                setIndependentSponsorForm({ ...independentSponsorForm, [fieldName]: e.target.value });
            }
        }
    }
                    ...
                    <>
                        <div className="w-full min-h-min flex-col justify-start items-start gap-8 inline-flex bg-white">
                            <div className="self-stretch h-[247px] flex-col justify-start items-start gap-6 flex">
                                <div className="text-center text-zinc-500 text-base font-normal  leading-tight" style={{ fontSize: "14px", fontFamily: "Degular" }}>INDEPENDENT SPONSOR</div>
                                        ...
                                        <div className="self-stretch h-[88px] flex-col justify-start items-start flex">
                                            ...
                                            <div className="self-stretch h-[88px] flex-col justify-start items-center gap-1 flex">
                                                <div className="self-stretch pb-4 justify-start items-center gap-px inline-flex">
                                                    <div className="text-blue-950 text-xl font-normal leading-tight" style={{ fontSize: "16px", fontFamily: "Degular" }}>Sponsor Name</div>
                                                </div>
                                                <div className="self-stretch px-4 py-3 bg-white rounded-sm border border-stone-300 justify-start items-center gap-2 inline-flex">
                                                    <input type='text' className="text-stone-700 text-lg font-normal  leading-snug border-none outline-none w-full" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} placeholder='Enter Sponsor Name'></input>
                                                </div>

                                                <div className="self-stretch pb-4 justify-start items-center gap-px inline-flex">
                                                    <div className="text-blue-950 text-xl font-normal pt-3 leading-tight" style={{ fontSize: "16px", fontFamily: "Degular" }}>Address</div>
                                                </div>
                        ...
                        <div className='flex gap-8' style={{ fontSize: "16px", fontFamily: "Degular" }}>
                            <div className='w-1/2  flex flex-col gap-3'>
                                ...
                                <InputField id="physicalZIP_code" type="text" placeholder="Enter Country" name='physicalZIP_code' style={{ fontSize: "0.875rem", fontFamily: "Degular" }} readOnly />
                            </div>
                            <div className='w-1/2 flex flex-col gap-3'>
                                <Label text="State" required='*' />
                                <InputField id="physicalLocation_Type" type="text" placeholder="Enter State" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} name='physicalLocation_Type' />
                            </div>
                        </div>
                        ...
                        <div className='flex gap-8 pt-10' style={{ fontSize: "16px", fontFamily: "Degular" }}>
                            ...
                            <div className='w-1/2 flex flex-col gap-3'>
                                ...
                                <InputField id="physicalLocation_Type" type="text" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} onChange={(e) => handleInputChange(e, "zipCode", "number")} placeholder="Enter ZipCode" name='physicalLocation_Type' />
                            </div>
                        </div>
                        ...
                        <div className="self-stretch h-[88px] flex-col justify-start items-center gap-1 flex pt-10">
                            <div className="self-stretch pb-4 justify-start items-center gap-px inline-flex">
                                <div className="text-blue-950 text-xl font-normal leading-tight" style={{ fontSize: "16px", fontFamily: "Degular" }}> BackGround of the Group and Investment Strategy</div>
                            </div>
                            <div className="self-stretch px-4 py-3 bg-white rounded-sm border border-stone-300 justify-start items-center gap-2 inline-flex">
                                <input type='text' className="text-stone-700 text-lg font-normal leading-snug border-none outline-none w-full" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} placeholder='Enter background and investment startegy'></input>
                            </div>
                        ...
                        <div className=" text-zinc-500 text-base font-normal leading-tight pt-10" style={{ fontSize: "14px", fontFamily: "Degular" }}>Firm Leadership</div>

                        <br />

                        <div className='flex gap-4' style={{ fontSize: "16px", fontFamily: "Degular" }}>
                            <div className='w-1/3 flex flex-col gap-3'>
                                <Label text="Name" />
                                <InputField id="physicalZIP_code" type="text" placeholder="Enter Name" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} name='physicalZIP_code' readOnly />
                            </div>
                            <div className='1/3 flex flex-col gap-3'>
                                <Label text="Position" />
                                <InputField id="physicalLocation_Type" type="text" placeholder="Enter Position" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} name='physicalLocation_Type' />
                            </div>
                            <div className='w-1/3 flex flex-col gap-3'>
                                <Label text="Ethinicity" />
                                <InputField id="physicalArea" type="text" placeholder="Enter Ethnicity" name='physicalArea' style={{ fontSize: "0.875rem", fontFamily: "Degular" }} />
                            </div>
                        </div>
                        ...
                        <div className='flex gap-8 pt-10' style={{ fontSize: "16px", fontFamily: "Degular" }}>
                            <div className='w-1/2 flex flex-col gap-3'>
                                <Label text="Number of Investor in Group" required='*' />
                                <InputField id="physicalZIP_code" type="text" placeholder="Enter no of investor in group" style={{ fontSize: "0.875rem", fontFamily: "Degular" }} onChange={(e) => handleInputChange(e, "numberOfInvestor", "number")}  name='physicalZIP_code' readOnly />
                            </div>
                            <div className='w-1/2 flex flex-col gap-3'>
                                <Label text="Number of Minority Investor" required='*' />
                                <InputField id="physicalLocation_Type" type="text" placeholder="Enter number of minority investor" onChange={(e) => handleInputChange(e, "numberOfMinority", "number")} style={{ fontSize: "0.875rem", fontFamily: "Degular" }} name='physicalLocation_Type' />
                            </div>
                        </div>
...
' />
                    <label className='cursor-pointer' htmlFor='capability-statement'>
                        <div className="px-4 py-2 bg-sky-50 border justify-start items-center gap-[7px] flex cursor-pointer">
                            ...
                            <div className="text-blue-950 text-base font-normal font-['Degular Demo'] leading-tight"><input className='hidden' type='file' id='capability-statement' />Upload</div>
                                ...
                                <div className='w-full flex flex-col gap-2'>
                                    <FileUpload label={`Released gain or loss`} maxSizeMB={50} onFilesChange={onFilesChange} fileName={`releasedGainOrLoss`} fileInfos={isAddPdf} setFileInfos={setAddPdf} validExtensions={['.pdf', '.doc', '.docx']} requiredText='*' toolTip={`If business premises are leased, rented, executive suite or virtaul office. 
                         If home base provide the signature page of the homeowners deed or mortgage receipt which shows the owners of the home`} />
                                    {/* 
                            <InputField placeholder={'Add comments if any'} type={'text'} /> */}
                                </div>
            ...
            <DialogActions>
                ...
                <Button onClick={() => handleSave(isAddPdf, "independentSponsor")} autoFocus>
                    Agree
                </Button>
            </DialogActions>
        </>
...
export default IndependentSponsor;