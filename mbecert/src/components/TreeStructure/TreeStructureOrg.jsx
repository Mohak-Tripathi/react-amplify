...
export default function TreeStructureOrg({ organizationName, isEdit, individualName }) {
    return (
        <div className="w-[400px] h-[52px] bg-white border border-gray-200 justify-start items-center gap-2 inline-flex">
            ...
            <div className="grow shrink basis-0 h-5 pl-2.5 pr-8 rounded-lg justify-start items-center gap-2 flex">
                <div className="grow shrink basis-0 text-blue-950 text-xl font-normal font-['Degular Demo'] leading-tight">{organizationName ? organizationName : individualName}</div>
            </div>
            {isEdit === true &&
